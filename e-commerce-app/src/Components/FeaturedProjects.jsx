  ...
  return (
    <div className="lg:my-[100px] xl:mx-[400px] mx-10 mt-10">
      <div className="top flex flex-col md:flex-row items-center md:justify-between mb-[50px]">
        <h1 className="text-2xl font-bold  md:basis-2/5">{type} Products</h1>
        <p className="md:basis-3/5 text-gray-500 text-center md:text-left">
          {type === "Featured"
            ...
            : "Fuel your workouts with our carefully selected range of powerhouse pre-workouts that will have you smashing through plateaus and pushing beyond your limits. Get ready to unleash your inner beast with our featured pre-workouts - the ultimate secret weapon for unrivaled performance!"}
        </p>
      </div>
